...
/// proper Rust error type which implements std::Error.
///
...
/// (`_CAN_ERR_FLAG`) is set. But there are additional types to handle any
...
impl crate::core_error::Error for CanError {}
...
impl crate::socketcan_embedded::Error for CanError {
            ...
            CanError::ControllerProblem(cp) => {
                ...
                match cp {
                    ReceiveBufferOverflow | TransmitBufferOverflow => {
                        crate::socketcan_embedded::ErrorKind::Overrun
                    }
                    _ => crate::socketcan_embedded::ErrorKind::Other,
                }
            }
            CanError::NoAck => crate::socketcan_embedded::ErrorKind::Noise ,
            _ => crate::socketcan_embedded::ErrorKind::Other,
        }
    }
}
...
//impl crate::socketcan_embedded::Error for ControllerProblem {}
...
///impl crate::socketcan_embedded::Error for ViolationType {}
...
//impl crate::socketcan_embedded::Error for CanErrorDecodingFailure {}
...
//impl crate::socketcan_embedded::Error for ConstructionError {}
